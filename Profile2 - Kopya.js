...
import { AppRegistry, TouchableOpacity, Image, FlatList, ActivityIndicator, StyleSheet, View, Platform, Text ,Dimensions} from 'react-native';
...
export default class App extends Component {
  ...
  componentDidMount() {
    fetch('https://api.myjson.com/bins/787fc')
